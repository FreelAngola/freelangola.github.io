...
<nav class="navbar navbar-expand-lg navbar-light bg-light ">
   ...
   <a href="perfilfreela.php"><button class="btn btn-outline-primary">  <?php echo"Para: ".$log?>  <img src="gokside.JPG"  width="20em" height="20em"class="img" alt=""> </button>
...
<hr>
<center><p class="arcs">Ficheiros suportados: docx, pdf, image, mp3, mp4, html, php, zip, js.</p></center>
...
<script src="dist/js/jquery.min.js"></script>
	...
	<script type="text/javascript">
		function scrollToBottom(el) { return el.scrollTop = el.scrollHeight; }
