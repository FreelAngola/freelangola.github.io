...
}?><br><a href="perpic.php">adicionar uma foto para o perfil</a><p class="perfil_name"><strong><?= $per?></strong><br><button id='post'><a href="seguidoresgokside.php" >Seguidores: <?php  
