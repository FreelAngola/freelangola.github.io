...
<li class="li">O <span> Freelancers Angola </span>é uma plataforma feita e para os angolanos, cujo o incentivo visa a motivar o povo Angolano a utilizar suas habilidades em prol do seu conhecimento e por sua vez arrecadar fundos significativos. <br> Uma plataforma onde todos os usuários dispões e ocupam funções ou seja dispõe um job cujo um Angolan freelancer poderá resolve-lo caso ambos concordem.
</li>
<li class="li"> Ajuda-nos a manter a startup protegidos de fraudes, phishing e perfis que se fazem passar por outras pessoas de modo a efectuar burlas. 
</li>
<li class="li">A plataforma suporta pagamentos pelo Paypal, transferência bancária, e <a href="e-kwanza.ao">E-Kwanza</a></li></ul>
...
<li class="li"><span>Apartir do momento em que criou sua conta, terá que possuir uma conta bancária e para isto a nossa plataforma utilisa o <a href="e-kwanza">E - Kwanza</a> cujo em minutos recebes uma sms para a criaçãoo da mesma .</li> 
</span> </ul>
<p> Não é permitido alguém fazer-se passar por outra pessoa ou qualquer outra entidade.</p>

<h4> Nota:</h4> Se o teu nome segue os nossos padrões e continuas com problemas em alterá-lo, descubre porquê. <br> O freelancer Angola tem o <span class="plano"><a href="#"> Plano +</a> </span>  , plano que facilita o utilizador na sua filtragem de pesquisa, isto é, jobs disponíveis cujo os requisitos vão de acordo com as suas competências então este cairá em primeira mão em forma de mensagem, isto é, nós coletamos ou reservamos para sí com custo adicional de 2% do pagamento, e caso largue ou esteja sem interesse nele será publicado no dashboard. <br>
